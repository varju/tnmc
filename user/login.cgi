  ...
  )
{
    ...
    &tnmc::log::log_login(0, $old_user, $old_user{username}, $userID, $user{username}, $password);
}
elsif ($userID) {
    ...
    &tnmc::log::log_login(1, $old_user, $old_user{username}, $userID, $user{username}, $password);
}
