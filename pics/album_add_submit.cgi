...
sub do_add_album {
    ...
    ## get the albumID
    $sql =
"SELECT albumID from PicAlbums WHERE albumTitle = ? AND albumOwnerID = ? AND albumDateStart = ? AND albumDateEnd = ? ORDER BY albumID DESC";
    ...
    if (!$albumID) {
        ...
        print
"Album May have been partially created, but pics could not be added. Please investigate this before trying again<br>\n";
        print "<hr> <b>Dump:</b> <b>";
        print %album;
